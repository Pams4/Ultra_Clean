                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation"  method = "POST" action = "">
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" name="first_name" class="form-control" id="yourName" value=" "required>
                    ...
                    <div class="col-12">
                      ...
                      <span class="error"> <?php echo $name_error;?></span>
                      <input type="text" name="last_name" class="form-control" id="yourEmail" value=" "required>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="number" name="phonenumber" class="form-control" id="yourUsername" value=" " required>
                    ...
                    <div class="col-12">
                      ...
                      <input type="email" name="email" class="form-control" id="youreventName" value=" " required>
                    ...
                    <div class="col-12">
                        ...
                        <input type="password" name="confpassword" class="form-control" id="yourPassword" value=""required>
                        <div class="invalid-feedback">Please enter your password again!</div>
                    </div>

                    <div class="col-12">
                    <label for="Services" class="form-label">Type of Client</label>
                    <select class="form-select form-select-sm" name = "typeofclient" value=" " aria-label=".form-select-sm example">
