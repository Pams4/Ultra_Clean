            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Here is Your Booking Details</h5>
                    <p class="text-center medium">You have up to 2 days to cancel this subscription with maximum refund!</br>
                    Just click on contact us and let us know that you would like to cancel.  </p>
                  </div>
                  ...
                  <div class="col-12">
                      ...
                      <div class="col-lg-9 col-md-8"> <?= $values['company_name'] ?></div>
                    </div>

                    <div class="col-12">
                      <label for="yourName" class="form-label">Email Address: </label>
                      <div class="col-lg-9 col-md-8"> <?= $values['company_email'] ?></div>
                    </div>

                    <div class="col-12">
                      <label for="yourName" class="form-label">Location: </label>
                      <div class="col-lg-9 col-md-8"> <?= $values['location'] ?></div>
                    </div>


                    <div class="col-12">
                      <label for="yourName" class="form-label"> Subscription Plan: </label>
                      <div class="col-lg-9 col-md-8"> <?= $values['subscription'] ?></div>
                    </div>

                    <div class="col-12">
                      <label for="yourName" class="form-label"> Your receipt: </label>
                      <div class="col-lg-9 col-md-8"> <?= $values['receit'] ?></div>
                    </div>

                    <div class="col-12">
                      <label for="yourName" class="form-label"> Submited at:  </label>
                      <div class="col-lg-9 col-md-8"> <?= $values['created'] ?></div>
                    </div>

                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit"  href="services.php?id=<?=$values['id']?>"> Back </button>
