    ...
    <main class="main" id="top">
      ...
      <!-- <section> begin ============================-->
        <section class="pb-0">
                  ...
                  <h1 class="text-center"> Welcome <?= $value['first_name'] ?> <?= $value['last_name'] ?> </h1>
                </div>
              </div>
            </div>
            <!-- end of .container-->
                          ...
                          <div class="col-md-4 mb-8 mb-md-0">
                            <div class="card card-span h-100 shadow">
                              <div class="card-body d-flex flex-column flex-center py-5"><img src="assets/img/residential.jpg" width="200" alt="..." />
                                <h5 class="mt-3">List of Cleaner's Bookings</h5>
                                <p class="mb-0 fs-xxl-1">For individual Clients</p>
                                <div class="text-center">
                                 <a button class="btn btn-outline-secondary rounded-pill" type="submit" href="#">Open Now</button></a>
                                </div>
                              </div>
                            </div>
                          </div>
                          <div class="col-md-4 mb-8 mb-md-0">
                            <div class="card card-span h-100 shadow">
                              <div class="card-body d-flex flex-column flex-center py-5"><img src="assets/img/office.jpg" width="200" alt="..." />
                                <h5 class="mt-3">List of Contract Registrations</h5>
                                <p class="mb-0 fs-xxl-1">For Companies </p>
                                <div class="text-center">
                                  <a button class="btn btn-outline-secondary rounded-pill" type="submit" href="#">Open Now</button></a>
                                </div>
                              </div>
                          ...
                          <div class="col-md-4 mb-8 mb-md-0">
                            <div class="card card-span h-100 shadow">
                              <div class="card-body d-flex flex-column flex-center py-5"><img src="assets/img/factory.png" width="220" alt="..." />
                                <h5 class="mt-3">List of complaints</h5>
                                <p class="mb-0 fs-xxl-1">From Your Clients</p>
                                <div class="text-center">
                                 <a button class="btn btn-outline-secondary rounded-pill" type="submit" href="#">Open Now</button></a>
                                </div>
                              </div>
