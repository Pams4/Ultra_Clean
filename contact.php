      ...
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="index.html"><img src="assets/img/ultraclean.png" width="118" alt="logo" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            ...
            </ul><a class="btn btn-sm btn-outline-primary rounded-pill order-1 order-lg-0 ms-lg-4" href="index.php">Log out</a>
          </div>
        </div>
      </nav>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center medium">Please fill this form below and a representative will get back to you via email. You can also call us on (+233 554401917)</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <label for="yourName" class="form-label">Your Concern</label>
                      <textarea type="text" name="name" cols="20" rows="5" class="form-control" id="youreventName" required></textarea>
                      <div class="invalid-feedback">Please, enter your current address!</div>
                    </div>


                    <div class="col-12">
                      <a button class="btn btn-primary w-100" type="submit" href="index.php">Submit</button></a>
                    </div>
                  </form>
