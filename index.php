        ...
        <div class="container"><a class="navbar-brand" href="index.html"><img src="assets/img/ultraclean.png" width="118" alt="logo" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
              <li class="nav-item px-2"><a class="nav-link" href="Login.php">Services</a></li>
              <li class="nav-item px-2"><a class="nav-link" href="Login.php">Request a Cleaner</a></li>
              <li class="nav-item px-2"><a class="nav-link" href="Login.php">Register your Company</a></li>
              <li class="nav-item px-2"><a class="nav-link" href="Login.php">Contact Us</a></li>
      ...
      <section class="py-xxl-10 pb-0" id="home">
        ...
        <div class="container">
          <div class="row min-vh-xl-100 min-vh-xxl-25">
            <div class="col-md-5 col-xl-6 col-xxl-7 order-0 order-md-1 text-end"><img class="pt-7 pt-md-0 w-100" src="assets/img/cleaning.png" alt="hero-header" /></div>
            <div class="col-md-75 col-xl-6 col-xxl-5 text-md-start text-center py-6">
              <h1 class="fw-light font-base fs-6 fs-xxl-7">We're <strong>UltraClean </strong>and<br />We're&nbsp;<strong>UltraPerfection.</strong></h1>
              <p class="fs-1 mb-5">You can get the services you need 24/7 – be it your office or in <br />your home. You will be treated by excellent service providers. </p><a class="btn btn-lg btn-primary rounded-pill" href="sign_up.php" role="button">Create an Account</a>
            </div>
          </div>
        </div>
      </section>
