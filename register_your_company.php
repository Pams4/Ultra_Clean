        ...
        <div class="container"><a class="navbar-brand" href="index.html"><img src="assets/img/ultraclean.png" width="118" alt="logo" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
              ...
              <li class="nav-item px-2"><a class="nav-link"  href="services.php?id=<?=$value['id']?>">Services</a></li>
              <li class="nav-item px-2"><a class="nav-link" href="request_a_cleaner.php?id=<?=$value['id']?>" >Request a Cleaner</a></li>
              <li class="nav-item px-2"><a class="nav-link"  href="register_your_company.php?id=<?=$value['id']?>" >Register your Company</a></li>
              <li class="nav-item px-2"><a class="nav-link" href="contact.php?id=<?=$value['id']?>">Contact Us</a></li>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method = "POST" action = "functions/form_update.php" >

                    <div class="col-12">
                      <label for="yourName" class="form-label">Name of the Company</label>
                      <input type="text" name="company_name" class="form-control" id="yourName" value="<?= $value['company_name'] ?>" required>
                    ...
                    <div class="col-12">
                      ...
                      <input type="email" name="company_email" class="form-control" id="yourEmail" value="<?= $value['company_email'] ?>"required>
                      <div class="invalid-feedback">Please enter your email!</div>
                    </div>

                    <div class="col-12">
                      <label for="yourName" class="form-label">Location</label>
                      <input type="text" name="location" class="form-control" id="yourName" value="<?= $value['location'] ?>" required>
                    ...
                    <div class="col-12">
                    <label for="Services" class="form-label">Select Your Subscription Plan</label>
                    <select class="form-select form-select-sm" name = "subscription" value="<?= $value['subscription'] ?>"aria-label=".form-select-sm example">
                    ...
                    <input type="hidden" name="created" value="<?= $value['created'] ?>">
                    <div class="col-12">
                        <p class="medium mb-0">Request a cleaner instead? <a href="request_a_cleaner.php">Click Here</a></p>
                      </div>
